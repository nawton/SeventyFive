...
const MUSCLE_KEYWORDS: Array<{ words: string[]; slugs: Slug[] }> = [
  ...
  { words: ['bänk', 'bench', 'bröst', 'chest', 'butterfly', 'korsning', 'crossover', 'flyes', 'pec', 'lutande', 'hantelpress ligg', 'kabelpress', 'push-up', 'pushup', 'armhäv'], slugs: ['chest', 'triceps', 'deltoids'] },
  ...
  { words: ['axelpress', 'shoulder', 'militär', 'overhead', 'arnold', 'push press', 'landmine'], slugs: ['deltoids', 'triceps'] },
  { words: ['sidolyft', 'frontlyft', 'delta', 'axellyft', 'axlar', 'lateral', 'upright'], slugs: ['deltoids'] },
  { words: ['handled', 'wrist', 'farmer'], slugs: ['forearm', 'trapezius'] },
  { words: ['bicep', 'curl', 'hammer'], slugs: ['biceps', 'forearm'] },
  { words: ['tricep', 'pushdown', 'skull'], slugs: ['triceps'] },
  { words: ['dip'], slugs: ['triceps', 'chest'] },
  { words: ['genomdrag', 'pull-through', 'good morning', 'swing'], slugs: ['gluteal', 'hamstring', 'lower-back'] },
  { words: ['glute', 'abduktion', 'abduction'], slugs: ['gluteal'] },
  { words: ['hyperextension', 'back extension'], slugs: ['lower-back', 'gluteal', 'hamstring'] },
  { words: ['rack pull'], slugs: ['lower-back', 'trapezius', 'upper-back'] },
  { words: ['sumo'], slugs: ['adductors'] },
  { words: ['thruster'], slugs: ['quadriceps', 'gluteal', 'deltoids'] },
  { words: ['rygg', 'pull', 'rodd', 'row', 'chin', 'lats', 'pulldown'], slugs: ['upper-back', 'biceps', 'trapezius'] },
  { words: ['mage', 'abs', 'ab wheel', 'plankan', 'plank', 'situp', 'crunch', 'core', 'benlyft', 'leg raise', 'twist', 'vridning', 'dragon', 'pallof', 'mountain'], slugs: ['abs', 'obliques'] },
